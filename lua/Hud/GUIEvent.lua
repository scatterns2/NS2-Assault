...
local function GetUnlockIconParams(unlockId)
    ...
    if not kUnlockIconParams then
        ...
        kUnlockIconParams[kTechId.TwoCommandStations] = { description = "EVT_ARMOR_LEVEL_2_RESEARCHED" }
        kUnlockIconParams[kTechId.ThreeCommandStations] = { description = "EVT_ARMOR_LEVEL_3_RESEARCHED" }
        
        kUnlockIconParams[kTechId.Weapons1] = { description = "EVT_WEAPON_LEVEL_1_RESEARCHED" }
        kUnlockIconParams[kTechId.TwoCommandStations] = { description = "EVT_WEAPON_LEVEL_2_RESEARCHED" }
        kUnlockIconParams[kTechId.ThreeCommandStations] = { description = "EVT_WEAPON_LEVEL_3_RESEARCHED" }
