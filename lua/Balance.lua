...
kPlayerResPerInterval = 0.15 // was 1.25, but players now also get res while dead

kKillTeamReward = 0
kPersonalResPerKill = 1
...
kMACBuildTime = 5
kExtractorBuildTime = 60

kInfantryPortalBuildTime = 30
