...
function TechTree:GetSpecialTechSupported(techId, structureTechIdList, techIdCount)
    ...
    elseif techId == kTechId.TwoCommandStations or techId == kTechId.ThreeCommandStations or techId == kTechId.FourCommandStations then    
    ...
    */
    ...
    elseif
	   ...
	   techId == kTechId.ThreeCommandStations or 
       techId == kTechId.ThreeHives or 
       techId == kTechId.ThreeShells or 
       techId == kTechId.ThreeSpurs or 
       techId == kTechId.ThreeVeils then
	
        return numBuiltSpecials >= 3
	else
		return numBuiltSpecials >= 4
    end
