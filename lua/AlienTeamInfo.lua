...
if Server then
    ...
    function AlienTeamInfo:OnUpdate(deltaTime)
        ...
        if team then
            ...
            self.veilLevel = Clamp(GetBuiltStructureCount("Veil", team:GetTeamNumber()), 0, 3) //- 1
            self.spurLevel = Clamp(GetBuiltStructureCount("Spur", team:GetTeamNumber()), 0, 3) //- 1
            self.shellLevel = Clamp(GetBuiltStructureCount("Shell", team:GetTeamNumber()), 0, 3) //- 1
