...
function PrototypeLab:GetItemList(forPlayer)
    ...
    return { kTechId.Jetpack, kTechId.Exosuit, kTechId.ClawRailgunExosuit, kTechId.Weapons1,kTechId.Weapons2,kTechId.Weapons3, kTechId.Armor1,kTechId.Armor2,kTechId.Armor3,  }
