...
function AlienTeam:SpawnInitialStructures(techPoint)
	...
	//SpawnStructure(self, techPoint, kTechId.Spur, Spur.kMapName)	
	//SpawnStructure(self, techPoint, kTechId.Veil, Veil.kMapName)	
	//SpawnStructure(self, techPoint, kTechId.Shell, Shell.kMapName)	
