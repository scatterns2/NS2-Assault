...
class 'MainCommandStation' (CommandStation)
MainCommandStation.kMapName = "maincommandstation"

function MainCommandStation:OnWeldOverride()

 end

Shared.LinkClassToMap("MainCommandStation", MainCommandStation.kMapName, { })