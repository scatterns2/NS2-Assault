...
local function GetBigIconPixelCoords(techId, researched)
    ...
    if not gBigIconIndex then
		...
		gBigIconIndex[kTechId.Weapons1] = 2
        gBigIconIndex[kTechId.Weapons2] = 2
        gBigIconIndex[kTechId.Weapons3] = 2
		gBigIconIndex[kTechId.Armor1] = 0
		gBigIconIndex[kTechId.Armor2] = 0
		gBigIconIndex[kTechId.Armor3] = 0
...
local function GetSmallIconPixelCoordinates(itemTechId)
    ...
    if not gSmallIconIndex then
		...
		gSmallIconIndex[kTechId.Weapons1] = 1
        gSmallIconIndex[kTechId.Weapons2] = 1
        gSmallIconIndex[kTechId.Weapons3] = 1
		gSmallIconIndex[kTechId.Armor1] = 4
		gSmallIconIndex[kTechId.Armor2] = 4
		gSmallIconIndex[kTechId.Armor3] = 4
