...
kExosuitHealth = 100    kExosuitArmor = 1200    kExosuitPointValue = 20
...
kOnosHealth = 1500    kOnosArmor = 500    kOnosPointValue = 30    kOnosHealtPerBioMass = 25

kMarineWeaponHealth = 400
        
kEggHealth = 500    kEggArmor = 0    kEggPointValue = 1
...
kCommandStationHealth = 2000    kCommandStationArmor = 500    kCommandStationPointValue = 25
...
kExtractorHealth = 1000 kExtractorArmor = 500 kExtractorPointValue = 15
kExtractorArmorAddAmount = 700 // not used

// (2500 = NS1)
kHarvesterHealth = 600 kHarvesterArmor = 100 kHarvesterPointValue = 15
